(function() {
  ...
  CardReactFormContainer = createReactClass({
    ...
    traverseChildrenAndRegisterInputs: function(children) {
      ...
      return React.Children.map(children, (function(_this) {
        return function(child) {
          ...
          if (child.props && child.props.name && child.type === 'input') {
    ...
    inputOnKeyUp: function(event) {
      ...
      return this.props.onInputChange && this.props.onInputChange(event);
    },
    inputOnFocus: function(event) {
      ...
      this.renderCardComponent();
      return this.props.onInputFocus && this.props.onInputFocus(event);
    },
    inputOnBlur: function(event) {
      this.focusedInput = '';
      this.cardFlipped = false;
      this.renderCardComponent();
      return this.props.onInputFocus && this.props.onInputBlur(event);
    },
